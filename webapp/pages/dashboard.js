  ...
  <section class="dashboard-page">
    ...
    <div class="search-row">
      ...
      <button id="open-filters-btn" class="filters-btn" type="button" aria-label="Abrir filtros" title="Abrir filtros">
        <svg class="filters-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
...
export async function wireDashboard({ navigate, user }) {
  ...
  function updateFiltersButtonState() {
    const hasActiveFilters = Boolean((activeFilters.series || []).length || activeFilters.dateFrom || activeFilters.dateTo);
    openFiltersBtn.classList.toggle('active', hasActiveFilters);
  }
